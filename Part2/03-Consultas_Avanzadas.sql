...
sum((od.UnitPrice * od.Quantity) - (od.UnitPrice * od.Quantity)* od.Discount) as 'Cantidad total vendida por producto'
from
Categories as c
inner join
Products as p
...
select 
c.CompanyName as 'Cliente',
sum((od.UnitPrice * od.Quantity) - (od.UnitPrice * od.Quantity)* od.Discount) as 'Cantidad total de $ gastado'
from
Orders as o
inner join
[Order Details] as od
...
c.CompanyName as 'Cliente',
o.OrderDate as 'Fecha de la orden',
sum(od.UnitPrice * od.Quantity) as 'Cantidad total'
from 
Customers as c
inner join
Orders as o
...
on o.OrderID = od.OrderID
group by o.OrderID, c.CompanyName, o.OrderDate
having sum(od.UnitPrice * od.Quantity) between 500 and 200;


select distinct o.OrderID as 'Id de la Orden',
sum((od.UnitPrice * od.Quantity) - (od.UnitPrice * od.Quantity)* od.Discount) as 'Cantidad total'
from 
Orders as o
inner join
[Order Details] as od
